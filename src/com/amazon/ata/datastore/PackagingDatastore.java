...
public class PackagingDatastore {
    ...
    private final List<FcPackagingOption> fcPackagingOptions = Arrays.asList(
            ...
            createPolyBag("IND1", Material.LAMINATED_PLASTIC, "10000"),
            createPolyBag("ABE2", Material.LAMINATED_PLASTIC, "2000"),
            createPolyBag("ABE2", Material.LAMINATED_PLASTIC, "10000"),
            createPolyBag("PDX1", Material.LAMINATED_PLASTIC, "2000"),
